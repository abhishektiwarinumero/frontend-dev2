<template>
  <div class="customer">
    <div class="customer-container-title">
      <v-icon class="shield-icon have-linear-gradient"
      ...
      <span class="headline font-weight-bold have-linear-gradient"
        >Excellent</span
      >
      <span class="d-block">
        4.77 Rating
    ...
    <div class="text-center customer-slider">
      <v-container>
        <v-slide-group
          v-model="model"
          class="pa-4"
